...
do
    cmd="CUDA_VISIBLE_DEVICES=${gpu} python train_chmed.py --modals=$modality 
        --path AIS10_norm-Vsent_avg_affectdenseface-Lsent_cls_robert_wwm_base_chinese4chmed
        ...
        --use_input_project
        --global_dim 800 --person_dim 800 --emotion_dim 128 --classifer_dim 128 --attention_dim 128
    "
    echo "\n-------------------------------------------------------------------------------------"
