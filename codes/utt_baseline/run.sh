...
#             --dropout_rate 0.5  --learning_rate 5e-4 --batch_size 64 --postfix self
#             --v_ft_type affectdenseface --v_input_size 342 --max_visual_tokens 70 --v_embd_method last
#             --a_ft_type wav2vec_zh --a_input_size 1024 --max_acoustic_tokens 150 --a_embd_method last
